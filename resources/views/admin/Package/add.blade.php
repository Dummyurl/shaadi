                    ...
                    <div class="portlet-body">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label for="sel1"><b>Package Name</b></label>
                                {!! Form::select('packages_id',[''=>'select Package'] + $Package,null,['class'=>'form-control','data-required' => true]) !!} 

                                @if ($errors->has('packages_id')) 
                                <span class="help-block">
                                <strong>{{ $errors->first('packages_id') }}</strong>
                                </span>
                                @endif
                            </div> 
                            <!-- Title-->
